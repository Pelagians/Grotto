...
check:
	...
	python3 -m py_compile runtimes/claude-desktop/root/usr/local/bin/grotto-claude-callback-listener
	python3 -m py_compile contrib/claude-host-bridge/grotto-claude-host-bridge
	python3 runtimes/claude-desktop/root/usr/local/bin/grotto-claude-browser --self-test
	python3 runtimes/claude-desktop/root/usr/local/bin/grotto-claude-callback-listener --self-test
	python3 contrib/claude-host-bridge/grotto-claude-host-bridge --self-test
