...
check:
	...
	bash -n runtimes/claude-desktop/root/usr/local/bin/grotto-claude-desktop
	...
	python3 -m py_compile runtimes/claude-desktop/root/usr/local/libexec/grotto-patch-claude-titlebar
	python3 runtimes/claude-desktop/root/usr/local/bin/grotto-claude-browser --self-test
	python3 runtimes/claude-desktop/root/usr/local/libexec/grotto-patch-claude-titlebar --self-test
